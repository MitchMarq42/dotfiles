...
** PATH variable
#+begin_src shell :tangle zprofile
  export PATH=/opt/local/bin:/opt/local/sbin:/opt/homebrew/bin:/opt/homebrew/sbin:~/.local/bin:$PATH:~/.local/share/cargo/bin:~/.local/share/brew/bin:~/.local/share/brew/sbin:/home/linuxbrew/.linuxbrew/bin
#+end_src
