...
(def-doom-theme mitch-doom-1337
  "A dark theme inspired by 1337 Theme, my version."

  ;; name        default   256       16
  ((bg         '("#000000" "#191919" nil))
   (bg-alt     '("#000000" "#222222"  nil))
   (base0      '("#000000" "#111122"   "black"))
   (base1      '("#020202" "#1C1C1C" "brightblack"))
   (base2      '("#ff0000" "#626262" "brightblack"))
   (base3      '("#00aa00" "#3D3D3D" "brightblack"))
   (base4      '("#ffee11" "#444444" "brightblack"))
   (base5      '("#0000ff" "#515151" "brightblack"))
   (base6      '("#ff00ff" "#6D6D6D" "brightblack"))
   (base7      '("#00ffff" "#767676" "brightblack"))
   (base8      '("#ffffff" "#a8a8a8" "white"))
   (fg         '("#d4d4d4" "#d4d4d4" "brightwhite"))
   (fg-alt     '("#AEAFAD" "#bcbcbc" "white"))

   (grey base7)
   (white        '("#FFFFFF" "#FFFFFF" "white"))
   (red          '("#FF0000" "#FF5E5E" "red"))
   (orange       '("#FFA000" "#FC9354" "brightred"))
   (green        '("#00aa00" "#468800" "green"))
   (light-green  '("#00c000" "#BBCCAA" "green"))
   (teal         '("#007755" "#33CCAA" "brightgreen"))
   (yellow       '("#ffee11" "#E9FDAC" "brightyellow"))
   (light-yellow '("#cccc66" "#FBE3BF" "brightyellow"))
   (blue         '("#0000ff" "#8CDAFF" "brightblue"))
   (dark-blue    '("#6699CC" "#6699CC" "blue"))
   (magenta      '("#ff00ff" "#CC88CC" "brightmagenta"))
   (violet       '("#9f00aa" "#BB88BB" "magenta"))
