...
** Tell vim to highlight the file as sh
(their zsh highlighting is ugly.)
#+begin_src shell :tangle ~/.config/zsh/zprofile
  # vim: set ft=sh :
#+end_src
...
#+begin_src shell :tangle ~/.config/zsh/zprofile
  export XDG_CACHE_HOME/xmonad
  export XDG_CONFIG_HOME/xmonad
  export XDG_DATA_HOME/xmonad
#+end_src
*** language-specific package managers
**** GHCup - just needs any value
#+begin_src shell :tangle ~/.config/zsh/zprofile
...
#+end_src
**** thankfully cargo/rust only needs one
#+begin_src shell :tangle ~/.config/zsh/zprofile
...
*** RC files
**** xinitrc
for some reason X doesn't pick up this value so we need to manually
specify it when invoking =startx= anyway.
#+begin_src shell :tangle ~/.config/zsh/zprofile
...
** PATH variable
#+begin_src shell :tangle ~/.config/zsh/zprofile
  export PATH=/opt/local/bin:/opt/local/sbin:/opt/homebrew/bin:/opt/homebrew/sbin:~/.local/bin:$PATH:~/.local/share/cargo/bin:~/.local/share/brew/bin:~/.local/share/brew/sbin
#+end_src
